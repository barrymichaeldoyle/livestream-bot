/**
 * Credits to Stoney_Eagle for the scopes list.
 * https://github.com/NoMercy-Entertainment/Stream-Overlay/blob/main/src/commands/shoutout.ts
 */

enum TwitchAccessTokenScope {
  /**
